...
public interface CommonUnit {
    /**
     * @return a default logger maintained by the implementation unit.
     */
     ...
     * @return generated new KeelEventLogger instance for the provided topic, by default with the KeelIssueRecordCenter instance maintained by this unit.
     */
    ...
    /**
     * @return An instance of KeelMetricRecorder, which should be started already. It should not return null, raise exception instead then.
     * @since 1.4.2
     */
    @Nonnull
